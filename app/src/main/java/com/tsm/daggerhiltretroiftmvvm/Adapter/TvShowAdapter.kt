package com.tsm.daggerhiltretroiftmvvm.Adapter
...
import coil.load
import com.tsm.daggerhiltretroiftmvvm.Model.TvShowItem
import com.tsm.daggerhiltretroiftmvvm.databinding.TvShowLayoutAdapteBinding

class TvShowAdapter: RecyclerView.Adapter<TvShowAdapter.MyViewHolder>() {
    inner class MyViewHolder(val binding: TvShowLayoutAdapteBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        return MyViewHolder(
            TvShowLayoutAdapteBinding.inflate(
